...
import { ERC721CUniqueComponentsMock, ERC1155CMock } from "../typechain";
import { BigNumber } from "ethers";

let erc721c: ERC721CUniqueComponentsMock;
...
export const testERC721CUniqueComponents = () => {
    before(async function () {
        // init contracts
        const ERC721C = await ethers.getContractFactory("ERC721CUniqueComponentsMock");
    ...
    describe("ERC721CUniqueComponents", function () {
        ...
        it("Should fail to attach a component because one is already attached", async function () {
            await expect(
